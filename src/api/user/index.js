...
export async function getUserInfoApi() {
  ...
  var test = await request.post(
    "http://shsd666.gnway.org:9999/NewWebApi/api/Values/Work2407",
    {
      CommandType: "select",
      database: "master",
      SqlsStr:
        "select 0 userId,cuser_id username,cuser_name nickname from ufsystem..ua_user where cuser_id='" +
        cuser_id +
        "'",
    }
  );
  ...
  test.data.avatar =
    "https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fb-ssl.duitang.com%2Fuploads%2Fitem%2F201806%2F12%2F20180612131829_AyMHU.gif&refer=http%3A%2F%2Fb-ssl.duitang.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1722879995&t=81140e0b3f46e9c87b56d392ed081b3f";
...
export function getUserInfoApi00() {
  return request({
    url: "/api/v1/users/me",
    method: "get",
  });
